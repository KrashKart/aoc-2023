...
one_rank = [14_101, 25_010, 11_831, 6_816, 32_645, 7_344, 15_939, 12_729]                           # rank for part 1
two_rank = [11_613, 24_146, 10_693, 7_384, 16_922, 5_753, 11_968, 8_778]                           # rank for part 2
two_stars_tot = [189_515, 157_181, 102_141, 99_698, 57_926, 72_937, 50_269, 8_952]                  # number of people that completed both parts
add = [60_711, 7_120, 15_244, 13_455, 24_329, 1_201, 5_969, 6_901]                                 # number of people that completed part 1 only
anomalies = [2, 5, 7, 8]                                                                       # days where I did not start on time

one_time = [(1,6,6), (3,44,38), (1,59,16), (0,18,0), (7,22,24), (0,22,7), (3,8,21), (1,18,15)]        # time taken for part 1 in (hrs, mins, secs)
two_time = [(2,3,32), (4,0,37), (2,34,4), (0,46,44), (8,38,27), (0,24,7), (3,8,29), (1,59,59)]        # time taken for part 2 in (hrs, mins, secs)
i = len(one_rank) + 1
